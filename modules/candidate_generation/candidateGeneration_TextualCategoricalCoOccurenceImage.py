...
class CandidateGenerationTextualCategoricalCoOccurenceImage(CandidateGeneration):
    ...
    def generateXY(self, dataset):
        ...
        return numpy.asarray(UserVector), numpy.asarray(TextualVector), numpy.asarray(CategoricalVector), numpy.asarray(CoOccurenceVector), numpy.asarray(ImageVector),numpy.asarray(Y), numpy.asarray(UserId), numpy.asarray(ItemId)
