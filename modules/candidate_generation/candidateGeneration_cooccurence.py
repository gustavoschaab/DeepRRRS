...
class CandidateGenerationCooccurence(CandidateGeneration):
    ...
    def defineModel(self):
        ...
        input_vecs = Concatenate()([userInput2, cooccurenceInput2])        
        ...
        model = Model(inputs=[userInput, cooccurenceInput], outputs=y)
    ...
    def generateXY(self, dataset):
        ...
        for _, row in dataset.iterrows():
            ...
            ItemVector.append(self.cooccurenceEmbeddings[row['ProductId']])
            Y.append(row['Rating'])
